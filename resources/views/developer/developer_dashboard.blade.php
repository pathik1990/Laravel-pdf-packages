        ...
        <div class="col-lg-3 col-md-6 col-sm-12 mb-30">
            <div class="card-box pd-30 height-100-p">
                <div class="progress-box text-center">
                    <input type="text" class="knob dial1" value="{{ $plansAndPackages['percentage'] }}" data-width="120" data-height="120" data-linecap="round" data-thickness="0.120" data-bgColor="#fff" data-fgColor="#1b00ff" data-angleOffset="180" readonly>
                    <h5 class="text-blue padding-top-10 h5">{{ $plansAndPackages['package_name'] }}</h5>
                    <span class="d-block">Usage {{ $plansAndPackages['usage_packages'] }} / {{ $plansAndPackages['total_packages'] }} Files <i class="fa fa-line-chart text-blue"></i></span>
                </div>
            </div>
        </div>
        @endif
