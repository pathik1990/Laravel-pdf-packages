        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
            <div class="pd-20 card-box height-100-p">
                <div class="profile-photo">
                    ...
                    <img src="{{ asset('images/user.png') }}" alt="" class="avatar-photo">
                ...
                <h5 class="text-center h5 mb-0">{{ $userInfo->name }}</h5>
                <p class="text-center text-muted font-14">{{ $userInfo->role }}</p>
                ...
                <div class="profile-info">
                    <h5 class="mb-20 h5 text-blue">Business Details</h5>
                    <ul>
                        <li>
                            <span><i class="icon-copy ion-briefcase"></i> Company Name</span>
                            {{ $businessDetails->company_name }}
                        </li>
                        <li>
                            <span><i class="icon-copy ion-android-globe"></i> Website</span>
                ...
                <div class="profile-skills">
                    <h5 class="mb-20 h5 text-blue">Project Usage</h5>
